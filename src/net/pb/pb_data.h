...
namespace jl
{
    ...
    public:
        ...
        PbRequest(const std::string &msg_id, const std::string &service_full_name, const std::string &pb_data) noexcept;
    ...
    public:
        ...
        PbResponse(const std::string &msg_id, const std::string &pd_data, DataErrorCode error_code = DataErrorCode::kNoError) noexcept;
